object frmDetalheEntrega: TfrmDetalheEntrega
  ...
  object qry_DetalhevendaCabecalho: TFDQuery
    ...
    SQL.Strings = (
        ...
        '.Cod_IDRegistro, venda_cab.ME_Hora_Separacao,venda_cab.ME_Hora_C' +
        'hegadaExp, venda_cab.CodEmp,venda_cab.Dt_Movto,venda_cab.Hr_Movt' +
        'o,'
    ...
    object qry_DetalhevendaCabecalhoME_Hora_Separacao: TDateTimeField
      FieldName = 'ME_Hora_Separacao'
    ...
    object qry_DetalhevendaCabecalhoME_Pronto_Entrega: TStringField
      FieldName = 'ME_Pronto_Entrega'
