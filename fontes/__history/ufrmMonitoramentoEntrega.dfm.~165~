object frmMonitoramentoEntrega: TfrmMonitoramentoEntrega
      ...
      object DBGrid_EntregaFinalizada: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Hora Finaliza'#231#227'o Entrega'
            Width = 130
            Visible = True
          end>
      end
  ...
  object FDQuery_VendasParaSeparar: TFDQuery
    ...
    SQL.Strings = (
        ...
        'rd_No,venda_cab.Cod_IDRegistro,concat(venda_cab.ME_Data_Separaca' +
        'o,'#39' '#39',venda_cab.ME_Hora_Separacao) as ME_Data_Separacao,venda_ca' +
        'b.ME_Hora_ChegadaExp, venda_cab.CodEmp,venda_cab.Dt_Movto,venda_' +
        'cab.Hr_Movto,'
    ...
    object FDQuery_VendasParaSepararME_Data_Separacao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ME_Data_Separacao'
  ...
  object FDQuery_ItensParaSeparacao: TFDQuery
    ...
    SQL.Strings = (
      ...
      'venda_pro.ME_Nome_User_Separador as Separador,'
        ...
        'concat(venda_pro.ME_Data_Separacao,'#39' '#39',venda_pro.ME_Hora_Separac' +
        'ao) as Data_Separacao,'
    ...
    object FDQuery_ItensParaSeparacaoData_Separacao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Data_Separacao'
      Origin = 'Data_Separacao'
      ProviderFlags = []
      ReadOnly = True
      Size = 19
    end
  ...
  object FDQuery_DetalhesItens: TFDQuery
    ...
    object FDQuery_DetalhesItensData_Separacao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Data_Separacao'
      Origin = 'Data_Separacao'
      ProviderFlags = []
