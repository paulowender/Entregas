object frmAlterarExpedicao: TfrmAlterarExpedicao
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Alterar expedi'#231#227'o de saida'
  ClientHeight = 158
  ClientWidth = 371
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 264
    Height = 13
    Caption = 'Informe para qual expedi'#231#227'o deseja enviar a entrega..'
  end
