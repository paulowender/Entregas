object frmCancelaEntrega2: TfrmCancelaEntrega2
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object btnGravar: TBitBtn
    ...
    Width = 250
    Height = 25
    Caption = 'CONFIRMAR CANCELAMENTO DA ENTREGA'
    Glyph.Data = {
      36030000424D3603000000000000360000002800000010000000100000000100
      18000000000000030000120B0000120B00000000000000000000FF00FFFF00FF
  ...
  object CheckBox_ExpFrente: TCheckBox
    Left = 24
    Top = 175
    Width = 257
    Height = 17
    Caption = 'Enviar para a conferencia da expedi'#231#227'o frente'
    TabOrder = 3
    OnClick = CheckBox_ExpFrenteClick
  end
  object CheckBox_ExpFundos: TCheckBox
    Left = 24
    Top = 198
    Width = 273
    Height = 17
    Caption = 'Enviar para a conferencia da expedi'#231#227'o fundos'
    TabOrder = 4
    OnClick = CheckBox_ExpFundosClick
  end
end
