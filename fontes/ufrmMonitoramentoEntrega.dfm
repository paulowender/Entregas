object frmMonitoramentoEntrega: TfrmMonitoramentoEntrega
  ...
  object FDQuery_VendasParaSeparar: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select clientes.Fone,clientes.Razao,clientes.Cpf_Cnpj, concat(cl' +
        'ientes.Endereco,'#39' '#39',clientes.End_Numero) as Endereco, clientes.B' +
        'airro,'
        ...
        'rd_No,venda_cab.Cod_IDRegistro,venda_cab.ME_Data_Separacao,venda' +
        '_cab.ME_Hora_Separacao,venda_cab.ME_Hora_ChegadaExp, venda_cab.C' +
        'odEmp,venda_cab.Dt_Movto,venda_cab.Hr_Movto,'
    ...
    object FDQuery_VendasParaSepararME_Obs: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ME_Obs'
      Origin = 'ME_Obs'
      Size = 300
    end
    object FDQuery_VendasParaSepararME_Data_Separacao: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'ME_Data_Separacao'
  ...
  object FDQuery_ItensParaSeparacao: TFDQuery
    ...
    SQL.Strings = (
      ...
      'venda_pro.ME_Hora_Separacao as Hora_Separacao,'
    ...
    object FDQuery_ItensParaSeparacaoData_Separacao: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'Data_Separacao'
      Origin = 'ME_Data_Separacao'
    end
    object FDQuery_ItensParaSeparacaoHora_Separacao: TTimeField
      AutoGenerateValue = arDefault
      FieldName = 'Hora_Separacao'
      Origin = 'ME_Hora_Separacao'
    end
  end
  ...
  object FDQuery_EndEntrega: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select clientes.razao, clientes.Cpf_Cnpj, clientes.Rg_Ie,cli_end' +
        'cobent.EndEntrega as EnderecoBD, cli_endcobent.EndEntrega_No as ' +
        'NumeroEnd,'
  ...
  object FDQuery_DetalhesItens: TFDQuery
    ...
    object FDQuery_DetalhesItensData_Separacao: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'Data_Separacao'
      Origin = 'ME_Data_Separacao'
    end
    object FDQuery_DetalhesItensHora_Separacao: TTimeField
      AutoGenerateValue = arDefault
      FieldName = 'Hora_Separacao'
      Origin = 'ME_Hora_Separacao'
    end
